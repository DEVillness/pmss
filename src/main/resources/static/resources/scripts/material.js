...
const d32Input = document.getElementById('d32').querySelectorAll(':scope > input');
const bipolarInput = document.getElementById('bipolar').querySelectorAll(':scope > input');
const polymerizerInput = document.getElementById('polymerizer').querySelectorAll(':scope > input');
const crystalline5Input = document.getElementById('crystalline5').querySelectorAll(':scope > input');
const device4Input = document.getElementById('device4').querySelectorAll(':scope > input');
const ketone4Input = document.getElementById('ketone4').querySelectorAll(':scope > input');
const oriron4Input = document.getElementById('oriron4').querySelectorAll(':scope > input');
const ester4Input = document.getElementById('ester4').querySelectorAll(':scope > input');
const sugar4Input = document.getElementById('sugar4').querySelectorAll(':scope > input');
const orirock4Input = document.getElementById('orirock4').querySelectorAll(':scope > input');
const kohl4Input = document.getElementById('kohl4').querySelectorAll(':scope > input');
const grindstone4Input = document.getElementById('grindstone4').querySelectorAll(':scope > input');
const manganese4Input = document.getElementById('manganese4').querySelectorAll(':scope > input');
const rma4Input = document.getElementById('rma4').querySelectorAll(':scope > input');
const alloy4Input = document.getElementById('alloy4').querySelectorAll(':scope > input');
const gel4Input = document.getElementById('gel4').querySelectorAll(':scope > input');
const crystalline4Input = document.getElementById('crystalline4').querySelectorAll(':scope > input');
const device3Input = document.getElementById('device3').querySelectorAll(':scope > input');
const ketone3Input = document.getElementById('ketone3').querySelectorAll(':scope > input');
const oriron3Input = document.getElementById('oriron3').querySelectorAll(':scope > input');
const ester3Input = document.getElementById('ester3').querySelectorAll(':scope > input');
const sugar3Input = document.getElementById('sugar3').querySelectorAll(':scope > input');
const orirock3Input = document.getElementById('orirock3').querySelectorAll(':scope > input');
const kohl3Input = document.getElementById('kohl3').querySelectorAll(':scope > input');
const grindstone3Input = document.getElementById('grindstone3').querySelectorAll(':scope > input');
const manganese3Input = document.getElementById('manganese3').querySelectorAll(':scope > input');
const rma3Input = document.getElementById('rma3').querySelectorAll(':scope > input');
const alloy3Input = document.getElementById('alloy3').querySelectorAll(':scope > input');
const gel3Input = document.getElementById('gel3').querySelectorAll(':scope > input');
const crystalline3Input = document.getElementById('crystalline3').querySelectorAll(':scope > input');
const device2Input = document.getElementById('device2').querySelectorAll(':scope > input');
const ketone2Input = document.getElementById('ketone2').querySelectorAll(':scope > input');
const oriron2Input = document.getElementById('oriron2').querySelectorAll(':scope > input');
const ester2Input = document.getElementById('ester2').querySelectorAll(':scope > input');
const sugar2Input = document.getElementById('sugar2').querySelectorAll(':scope > input');
const orirock2Input = document.getElementById('orirock2').querySelectorAll(':scope > input');
const device1Input = document.getElementById('device1').querySelectorAll(':scope > input');
const ketone1Input = document.getElementById('ketone1').querySelectorAll(':scope > input');
const oriron1Input = document.getElementById('oriron1').querySelectorAll(':scope > input');
const ester1Input = document.getElementById('ester1').querySelectorAll(':scope > input');
const sugar1Input = document.getElementById('sugar1').querySelectorAll(':scope > input');
const orirock1Input = document.getElementById('orirock1').querySelectorAll(':scope > input');
